...
export default function ValuesCarousel() {
  ...
  const INSTAGRAM_URLS = [
    "https://www.instagram.com/p/CynKRK_ruYT/",
    "https://www.instagram.com/p/Cww8v9LLu_5/",
    "https://www.instagram.com/p/CwQIhrIM1C0/",
    "https://www.instagram.com/p/CfLyzKvrQMM/",
    "https://www.instagram.com/p/CRRbaZ1Hg-i/",
    "https://www.instagram.com/p/Cbf-9MQrvF1/",
    "https://www.instagram.com/p/CKB8DB5LduL/",
  ];
    ...
    <div className="container">
      <aside className="carousel">
        <div className="carousel__wrapper">
          {images.map((src, index) => (
            <a key={index} className="item" id={`slide-${index}`}>
              <img
                src={src}
                alt={`Slide ${index}`}
                width="418"
                height="418"
                onClick={() => {
                  window.open(INSTAGRAM_URLS[index], "_blank");
                }}
              />
            </a>
          ))}
      ...
      <article className="instagram">
        <header className="instagram__header">
          <figure>
            <img
              src="/images/vkus-insta.png"
              alt="BUREKCILNICA VKUS 5+"
              width="42"
              height="42"
            />
            <figcaption>
              <h4>burekcilnica_vkus5plus</h4>
            </figcaption>
          </figure>
        </header>
